...
//		else {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            $this->model_catalog_product->editProductProperty($this->request->get['product_id'], $this->request->post['key'], $this->request->post['value']);
        }
        else {
...
//        if ($api_info && $this->user->hasPermission('modify', 'product/edit')) {
